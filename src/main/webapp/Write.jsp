												...
												<form method="get" action="writeAction2.jsp">
															...
															<tr>
																<th><span>상품목록</span>
																	<select id="select" style="width: 100%;"
																		name="select" onchange="showTitle()">
																		<option id="option" value="구매 도서를 확인하세요">구매 도서를
																			확인하세요
																		</option>
														...
														<tbody style="background-color: #eeeeee">
															<tr>
																<td><input id="titl" type="text" class="form-control"
																		placeholder="글 제목" name="review_title"
																		maxlength="50"></td>
															</tr>
															<tr>
																<td><textarea type="text" class="form-control"
																		placeholder="글 내용" name="review_contents"
																		maxlength="2048"
													...
													<div class="bbs"
														...
														<input id="saveBtn" type="submit"
															class="btn btn-outline-primary" value="저장하기">
