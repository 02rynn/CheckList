		...
		<form method="post" action="update_review_proc.jsp?bbsID=<%= user.toString() %>">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
				...
				<tbody>
					<tr>
						<td>
						<input type="text" class="form-control" placeholder="글 제목" name="bbsTitle_modi" maxlength="50" value="<%= title %>">
						</td>
					</tr>
					<tr>
			...
			<button id="removeBtn" name ="removeBtn" type="submit" class="btn btn-primary pull-right" value="<%=rvNum %>">글삭제</button>
				...
				<form method="post" action="updateAction.jsp?bbsID=<%= user.toString() %>">
					<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd;">
						...
						<tbody>
							<tr>
								<td>
								<input  disabled type="text" class="form-control" placeholder="글 제목" name="bbsTitle" maxlength="50" value="<%= title %>">
								</td>
							</tr>
							<tr>
								<td><textarea readonly class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 350px;"><%=  content %></textarea></td>
							</tr>
						</tbody>
					</table>
