				...
				<%@ page import="java.util.*" %>
					...
					<head>
						...
						<style>
							...
							.item-wrapper.text-title p,
							.designSettingElement.text-titleWithFontSize {
								color: #000000;
													...
													<% int sum=0; for (Book info : bk) { sum+=info.getPrice(); %>
														...
														<tr>
															<td> <input type="submit" value="삭제"
																	onclick="location.href='deleteBookInCart_proc.jsp?isbn=<%=info.getIsbn()%>&id=<%=user%>'" />
															</td>
															<td><a href=""><img src="<%=info.getThumbnail()%>" /></a>
															</td>
															...
															<%-- <input name="isbn" type="hidden"
																...
																<%-- <input id=<%=info.getIsbn() %> type="submit"
																	value="저장"> --%>
																	<!--                                                 </form> -->


																	<%-- <input type="submit" value="삭제"
																		onclick="location.href='deleteBookInCart_proc.jsp?isbn=<%=info.getIsbn()%>&id=asd'" />
																	--%>
																	<!--                                             </td> -->
														</tr>
											...
											<div class="tb-total clearfix">
												<div id="cartInfoDiv" class="info designSettingElement shape">
													<div class="price">
														...
														<div id="cartTotalProductPrice" class="content"></div>
													</div>
												...
												<div id="cartTotalDiv" class="total">
													...
													<div id="cartTotalDiscountAppliedPrice" class="content bold">
														<%=sum %>원
													</div>
												</div>
											</div>
