        ...
        <%@page import="org.json.simple.JSONObject" %>
            ...
            <body>
                <%@ include file="navBar.jsp" %>
                    <% out.print(user); String isbn=request.getParameter("isbn"); BookDao dao=new BookDao(); JSONObject
                        item=dao.getAladinItemForDetail(isbn); out.print(user); %>
                            ...
                            <div class="bookDetailInfo" style="margin-right: 70px; width:40%">
                                ...
                                <div id="productAdditionalInfo" class="row productInfo designSettingElement text-body">
                                    ...
                                    <div class="js-extraFeeDescription hide" style="margin-top: 0;">
                                        <span class="title"></span> <span class="shopSettingShipmentInfo description">
                                        </span>
                                    </div>
                                </div>
...
<!--                                             </form> -->
                                ...
                                <div class="row naverPayButton">
                                    <script type="text/javascript" src="//pay.naver.com/customer/js/naverPayButton.js"
                                        charset="UTF-8">
                                        </script>
