...
<head>
	...
	<style>
		...
		* {
		...
		.designSettingElement.shape .cke_contents {
			...
			<div class="column-wrapper two-column">
				...
				<div class="memberInfo field">
					...
					<div class="content designSettingElement text-body">
						...
						<div class="row">
							<label for="customerId" class="title">아이디</label> <input type="text" name="customerId"
								class="designSettingElement shape" readonly value="<%=cus.getId()%>">

						</div>

						<div class="row">
							<label for="customerId" class="title">비밀번호</label> <input type="text" name="customerPw"
								class="designSettingElement shape" value="<%=cus.getPassword()%>">

						</div>

						<div class="row">
							<label for="customerEmail" class="title">이메일</label> <input type="email"
								name="customerEmail" class="designSettingElement shape" value="<%=cus.getEmail()%>">
						</div>
						...
						<div class="row name">
							...
							<span class="title">이름</span> <input name="customerName" type="text"
								class="designSettingElement shape" readonly value="<%=cus.getCustomer_name()%>">
					...
					<br /> <input type="submit" id="updateBtn" class="designSettingElement button" value="수정" />
				</div>
			</div>
		</div>
		</div>
