                    ...
                    <body>
                        <%@ include file="navBar.jsp" %>
                            ...
                            <% //String user=(String)session.getAttribute("userId"); // out.print(user); // String
                                isbn=request.getParameter("isbn"); // String title=request.getParameter("title"); //
                                String nail=request.getParameter("imgUrl"); // int
                                price=Integer.parseInt((request.getParameter("price")).toString()); String
                                title=request.getParameter("title"); out.print(title); bBsDAO dao1=new bBsDAO();
                                            ...
                                            <div class="product-order-summary-info designSettingElement shape">
                                                ...
                                                <div class="product-order-summary-row">
                                                    <span class="title">총 상품 금액</span> <span class="row-content">
                                                        <span id="product-order-total-price">
                                                            <%=bList.get(0).getPrice() %>
                                                        </span>
                                                    </span>
                                                </div>
                                            ...
                                            <div class="normalButton"
                                                ...
                                                <div class="btn-wrapper buyButton">
                                                    ...
                                                    <form action="buyNowCartNo.jsp" method="get">
                                                        <input name="isbn" value=<%=bList.get(0).getIsbn() %>
                                                        type="hidden" />
                                                        <input name="price" value=<%=bList.get(0).getPrice() %>
                                                        type="hidden" />
                                                        <input name="title" value=<%=bList.get(0).getTitle() %>
                                                        type="hidden" />
                                                ...
                                                <div class="btn-wrapper cartButton " style="margin-left: 10px;">
                                                    ...
                                                    <form action="insertBookInCart_proc.jsp" method="post">
                                                        ...
                                                        <button type="submit" value="<%=bList.get(0).getTitle()%>"
                                                            name="isbn" onclick="service()" id="btn_addToCart"
            ...
            maxlength:50;">
                                                <thead>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="background-color: #eeeeee; text-align: center;">상품이름
                                                        </th>
                                                        <th style="background-color: #eeeeee; text-align: center;">제목
                                                        </th>
                                                        <th style="background-color: #eeeeee; text-align: center;">글쓴이
                                                        </th>
                                                        <th style="background-color: #eeeeee; text-align: center;">등록일
                                                        </th>
                                                        <th style="background-color: #eeeeee; text-align: center;">평점
                                                        </th>
                                                    </tr>
                                                </thead>
                                                            ...
                                                            <%=r.getReview_num()%>
                                                                <tr>
                                                                    ...
                                                                    <td><a style="text-decoration : none;"
                                                                            href="bbs_bookDetail.jsp?title=<%=r.getReview_title() %>">
                                                                            <%=r.getReview_title() %>>
                                                                        </a></td> <!-- 상세페이지로 가도록  -->
                                                                    <td><a style="text-decoration : none;"
                                                                            href="watchReview.jsp?writer=<%=r.getId()%>&title=<%=r.getReview_title()%>&content=<%=r.getReview_contents()%>&rate=<%=r.getReview_rate()%>&num=<%= r.getReview_num() %>">
                                                                            <%= r.getReview_title() %>
                                                                        </a></td>
                                                                    <td>
                                                                        <%= r.getId() %>
                                                                    ...
                                                                    <td>
                                                                        <% if(r.getReview_rate()==1){
                                                                            out.println("★☆☆☆☆"); }else
                                                                            if(r.getReview_rate()==2){
                                                                            out.println("★★☆☆☆"); }else
                                                                            if(r.getReview_rate()==3){
                                                                            out.println("★★★☆☆"); }else
                                                                            if(r.getReview_rate()==4){
                                                                            out.println("★★★★☆"); }else{
                                                                            out.println("★★★★★"); } %>
                                                                    </td>
