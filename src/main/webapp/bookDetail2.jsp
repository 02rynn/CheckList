                                            ...
                                            <div id='shopProductImgsMainDiv' class='main img-div img'>
                                                <div class='shopProductImgMainWrapper type_thumbnails sequence_0 on'
                                                    ...
                                                    <img data-shopProductSequence=' 0'
                                                        ...
                                                        style="width: 60%; margin: 30px" src=<%=nail %>>
                                            ...
                                            <div class="normalButton"
                                                ...
                                                <div class="btn-wrapper buyButton">
                                                    ...
                                                    <form action="buyNowCartNo.jsp" method="get">
                                                        ...
                                                        <button type="submit" id="btn_buyNow" class="btn btn-primary" data-is-mini-cart-available="false">구매하기</button>
                                                    </form>
                                                </div>
                                                <div class="btn-wrapper cartButton " style="margin-left: 10px;">
                                                    ...
                                                    <form action="insertBookInCart_proc.jsp" method="post">
                                                        ...
                                                        <button type="submit" value="<%=isbn%>" name="isbn"
                                                            onclick="service()" id="btn_addToCart" class="btn btn-primary" data-is-mini-cart-available="false">
                                                            장바구니에 담기</button>
